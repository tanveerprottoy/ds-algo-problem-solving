...
public class Main {
    ...
    public static void main(String[] args) {
        // System.out.println(Arrays.toString(Sort.insertionSort(new int[] {5, 2, 4, 6, 9})));
        ...
        /*
         * System.out.println( LeetCode.findMedianSortedArrays( new int[] { 1, 2 }, new
         * int[] { 3, 4 } ) ); System.out.println( LeetCode.findMedianSortedArrays( new
         * int[] { 1, 2, 3, 6, 7 }, new int[] { 4, 6, 8, 10, 11, 12, 13 } ) );
         */
        /*
         ...
         * }))); System.out.println(Arrays.toString(General.reverseArray(new char[] {
         * 'C', 'B', 'A' })));
         * 
         * // ds System.out.println("" + Bracket.isBalanced( "{[()]}" ));
         */
